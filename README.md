...
The pipe executes all three commands in sequence:
...
But you can setup your own users, roles and IAM permission, considering that those roles can deploy aws cloudformation/sam applications and upload to the corresponding S3 buckets.
